...
const sendDataHandle = () => {
  ...
  shipmentForm.value.name =
    shipmentForm.value.name == null ? "" : shipmentForm.value.name;
  shipmentForm.value.surnames =
    shipmentForm.value.surnames == null ? "" : shipmentForm.value.surnames;
  shipmentForm.value.address =
    shipmentForm.value.address == null ? "" : shipmentForm.value.address;
  shipmentForm.value.postal_code =
    shipmentForm.value.postal_code == null
      ? ""
      : shipmentForm.value.postal_code;
  shipmentForm.value.province =
    shipmentForm.value.province == null ? "" : shipmentForm.value.province;
  shipmentForm.value.city =
    shipmentForm.value.city == null ? "" : shipmentForm.value.city;
  if (
    shipmentForm.value.name.trim() != "" &&
...
onMounted(() => {
  document
    .getElementById("input_postal_code")
...
const postalCodeChange = () => {
  if (shipmentForm.value.postal_code.length != 5) {
    ...
    axios
      .get(
        api + props.chatId + "/localization/" + shipmentForm.value.postal_code
      )
      .then(function (response) {
        if (response.data.error) {
          addressProvinces.value = [];
    ...
    <div class="shipment-page-form_container">
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          ...
          <input
            v-model="shipmentForm.e_mail"
            type="text"
            class="form-control"
            :placeholder="trans('80989dcf-1fe8-422d-bf41-34ebc7263295')"
            @focus="focusHandle"
            @blur="blurHandle"
          />
        </div>
      ...
      <select
        ...
        class="form-select shipment-page-form_input_container"
      >
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          ...
          <input
            ...
            type="text"
            :class="validateInput(shipmentForm.name)"
            :placeholder="trans('f47322cd-ba51-4cf0-8280-31de8073da80') + ' *'"
            @focus="focusHandle"
            @blur="blurHandle"
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          ...
          <input
            v-model="shipmentForm.surnames"
            type="text"
            :class="validateInput(shipmentForm.surnames)"
            :placeholder="trans('de5f0adb-d8eb-4312-9606-64a1075f422d') + ' *'"
            @focus="focusHandle"
            @blur="blurHandle"
            pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ.,:;@#¿?¡!()\-_ ]*"
          />
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          <div class="input-group-prepend">
            <div class="input-group-text">
              <font-awesome-icon :icon="['fass', 'building']" />
            </div>
          </div>
          <input
            ...
            :placeholder="trans('09ff692f-082d-4ed6-9998-5a65e8f6aa9a') + ' *'"
            @focus="focusHandle"
            @blur="blurHandle"
          />
        </div>
      ...
      <div class="shipment-page-form_input_container">
        ...
        <input
          ...
          id="city_browser"
          :class="validateInput(shipmentForm.city)"
          pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ.,:;@#¿?¡!()\-_ ]*"
          @focus="focusHandle"
          @blur="blurHandle"
        />
      ...
      <div class="shipment-page-form_input_container">
        ...
        <input
          v-model="shipmentForm.province"
          id="province_browser"
          :class="validateInput(shipmentForm.province)"
          pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ.,:;@#¿?¡!()\-_ ]*"
          @focus="focusHandle"
          @blur="blurHandle"
        />
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          ...
          <input
            ...
            type="text"
            :class="validateInput(shipmentForm.address)"
            :placeholder="trans('070d3f08-490c-48fa-b3f5-09c80d26b2f8') + ' *'"
            @focus="focusHandle"
            @blur="blurHandle"
            pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ.,:;@#¿?¡!()\-_ ]*"
          />
      ...
      <div class="shipment-page-form_input_container">
        <div class="input-group mb-2">
          ...
          <input
            v-model="shipmentForm.telephone"
            type="text"
            class="form-control"
            :placeholder="trans('d15f88d0-48fc-4b48-b2a8-1f858bc806d8')"
            @focus="focusHandle"
            @blur="blurHandle"
            pattern="[A-Za-z0-9ñÑáéíóúÁÉÍÓÚüÜ.,:;@#¿?¡!()\-_ ]*"
          />
      ...
      <select
        v-model="shipmentForm.payment_method"
        class="form-select shipment-page-form_input_container"
      >
        <option v-for="payment in paymentMethods" :value="payment.id">
          {{ payment.label }}
        </option>
      </select>
    </div>
